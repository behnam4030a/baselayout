    ...
    article.innerHTML =
      ...
      '<div class="group-card__btns">' +
        ...
        '<button class="group-card__delete-btn" type="button" aria-label="حذف گروه ' + safe + '">' +
          '<svg viewBox="0 0 24 24" fill="none" width="18" height="18"><path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>' +
        '</button>' +
      '</div>';
